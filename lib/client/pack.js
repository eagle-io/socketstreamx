...
module.exports = function(ss, client, options, jsIntegrity) {
  ...
  packAssetSet = function(assetType, paths, dir, postProcess) {
    ...
    writeFile = function(fileContents) {
      ...
      fileData = postProcess(fileContents)
      if (assetType === 'js') jsIntegrity[client.name] = ssri.fromData(fileData).toString();;
