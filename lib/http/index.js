...
module.exports = function(root) {
  return {
    ...
    load: function(staticPath, sessionStore, sessionOptions) {
      ...
      // Assign OUR cookie secret and dont load connect favicon middleware.
      // Also allow secure setting to be specified in middleware config. and add proxy=true flag (so it looks at the X-Forwarded-Proto header to confirm request originated over SSL)
